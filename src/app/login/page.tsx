      ...
      >
        <div className="glass rounded-2xl p-8 space-y-6 bg-background/50 backdrop-blur-xl">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-muted-foreground">Sign in to your JobLens AI account</p>
          </div>

          {/* Google Sign In */}
          <Button variant="outline" type="button" onClick={handleGoogleLogin} className="w-full py-5 rounded-xl glass hover:bg-white/5 transition-colors">
          ...
          <form className="space-y-4" onSubmit={handleLogin}>
            ...
            <div className="space-y-2">
              <div className="flex justify-between">
                ...
                <Link href="/forgot-password" className="text-xs text-indigo-500 hover:text-indigo-400 transition-colors">Forgot?</Link>
              </div>
              <div className="relative">
            ...
            <Button disabled={loading} className="w-full py-5 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white border-0 transition-all shadow-lg hover:shadow-indigo-500/25" type="submit">
